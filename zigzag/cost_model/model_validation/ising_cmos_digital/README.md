...
| RTL imeplementation | [rtl.py](./rtl.py) | A RTL imeplementation of SACHI architecture |
...
If you want to replicate the validation results, run the command below:

```bash
python validation_top.py
```
...
| Workload | Graph topology | Ising nodes (N) | Average graph degree | Weight precision | With magnetic field (h) | Latency mismatch (%) | Energy mismatch (%) |
|:-|:-|:-|:-|:-|:-|:-|:-|
| MIMO_N8 | Dense | 8 | 7 | 4b | Y  | -0.1 | NA |
| MIMO_N16 | Dense | 16 | 15 | 4b | Y | -0.1 | NA |
| MIMO_N32 | Dense | 32 | 31 | 4b | Y | -0.1 | NA |
| MIMO_N64 | Dense | 64 | 63 | 4b | Y | -0.1 | NA |
| MIMO_N128 | Dense | 128 | 127 | 4b | Y | 0 | NA |
| MIMO_N256 | Dense | 256 | 255 | 4b | Y | 0 | NA |
| MIMO_N512 | Dense | 512 | 511 | 4b | Y | 0 | NA |
| Average | | | | | | -0.1 | NA |
