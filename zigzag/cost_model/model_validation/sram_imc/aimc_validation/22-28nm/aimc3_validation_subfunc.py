...
from aimc_cost_model import ADC
from dimc_cost_model import Adder, MemoryInstance, MultiplierArray, UnitDff


def aimc3_cost_estimation(aimc, cacti_value):
    _unit_reg = UnitDff(aimc["unit_area"], aimc["unit_delay"], aimc["unit_cap"])
    ...
    """
    adder_tree = Adder(
        vdd=aimc["vdd"], input_precision=6, unit_area=unit_area, unit_delay=unit_delay, unit_cap=unit_cap
    )
